...
const ptBR: Translations = {
  ...
  howItWorks: {
    ...
    step3Desc:
      "Entre em contato com os especialistas diretamente e agende seu serviço conforme sua conveniência",
  },
  ...
  createManers: {
    strings: {
      ...
      hourlyRate: "Valor por Hora",
      subtitle:
        "Junte-se à nossa comunidade de profissionais verificados e conecte-se com clientes que precisam dos seus serviços.",
    },
    placeholders: {
      firstName: "João",
      lastName: "Silva",
